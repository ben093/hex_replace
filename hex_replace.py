...
def replace_hex(original_path, new_bin_path, start_region=0x0):
    # original_path is path (including file name) to starting file
    # new_bin_path is path (incl file name) to overwrite with
    # start_region is offset which to start replacing
    ...
    # Iterate length of file and replace original file in byte array
